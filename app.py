...
async def resolve_tickers(payload: Dict = Body(...)):
    ...
    try:
        ...
        # Static mapping for ETFs, crypto, and other assets
        static_assets = {
            # ETFs
            "SPY": {"name": "SPDR S&P 500 ETF Trust", "category": "Large Cap", "assetClass": "etf"},
            "VOO": {"name": "Vanguard S&P 500 ETF", "category": "Large Cap", "assetClass": "etf"},
            "VTI": {"name": "Vanguard Total Stock Market ETF", "category": "Large Cap", "assetClass": "etf"},
            "QQQ": {"name": "Invesco QQQ Trust", "category": "Technology", "assetClass": "etf"},
            "IWM": {"name": "iShares Russell 2000 ETF", "category": "Small Cap", "assetClass": "etf"},
            "EFA": {"name": "iShares MSCI EAFE ETF", "category": "International", "assetClass": "etf"},
            "EEM": {"name": "iShares MSCI Emerging Markets ETF", "category": "Emerging Markets", "assetClass": "etf"},
            "BND": {"name": "Vanguard Total Bond Market ETF", "category": "Bond", "assetClass": "etf"},
            "AGG": {"name": "iShares Core U.S. Aggregate Bond ETF", "category": "Bond", "assetClass": "etf"},
            "GLD": {"name": "SPDR Gold Shares", "category": "Commodity", "assetClass": "etf"},
            "VNQ": {"name": "Vanguard Real Estate ETF", "category": "Real Estate", "assetClass": "etf"},
            
            # Cryptocurrencies (spot prices)
            "BTC": {"name": "Bitcoin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ETH": {"name": "Ethereum", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ADA": {"name": "Cardano", "category": "Cryptocurrency", "assetClass": "crypto"},
            "SOL": {"name": "Solana", "category": "Cryptocurrency", "assetClass": "crypto"},
            "DOGE": {"name": "Dogecoin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BNB": {"name": "Binance Coin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "XRP": {"name": "Ripple", "category": "Cryptocurrency", "assetClass": "crypto"},
            "MATIC": {"name": "Polygon", "category": "Cryptocurrency", "assetClass": "crypto"},
            "AVAX": {"name": "Avalanche", "category": "Cryptocurrency", "assetClass": "crypto"},
            "DOT": {"name": "Polkadot", "category": "Cryptocurrency", "assetClass": "crypto"},
            "LINK": {"name": "Chainlink", "category": "Cryptocurrency", "assetClass": "crypto"},
            "LTC": {"name": "Litecoin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BCH": {"name": "Bitcoin Cash", "category": "Cryptocurrency", "assetClass": "crypto"},
            "XLM": {"name": "Stellar", "category": "Cryptocurrency", "assetClass": "crypto"},
            "VET": {"name": "VeChain", "category": "Cryptocurrency", "assetClass": "crypto"},
            "TRX": {"name": "TRON", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ATOM": {"name": "Cosmos", "category": "Cryptocurrency", "assetClass": "crypto"},
            "NEAR": {"name": "NEAR Protocol", "category": "Cryptocurrency", "assetClass": "crypto"},
            "FTM": {"name": "Fantom", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ALGO": {"name": "Algorand", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ICP": {"name": "Internet Computer", "category": "Cryptocurrency", "assetClass": "crypto"},
            "FIL": {"name": "Filecoin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "THETA": {"name": "Theta Network", "category": "Cryptocurrency", "assetClass": "crypto"},
            "XTZ": {"name": "Tezos", "category": "Cryptocurrency", "assetClass": "crypto"},
            "EOS": {"name": "EOS", "category": "Cryptocurrency", "assetClass": "crypto"},
            "AAVE": {"name": "Aave", "category": "Cryptocurrency", "assetClass": "crypto"},
            "UNI": {"name": "Uniswap", "category": "Cryptocurrency", "assetClass": "crypto"},
            "SUSHI": {"name": "SushiSwap", "category": "Cryptocurrency", "assetClass": "crypto"},
            "COMP": {"name": "Compound", "category": "Cryptocurrency", "assetClass": "crypto"},
            "MKR": {"name": "Maker", "category": "Cryptocurrency", "assetClass": "crypto"},
            "YFI": {"name": "Yearn.finance", "category": "Cryptocurrency", "assetClass": "crypto"},
            "SNX": {"name": "Synthetix", "category": "Cryptocurrency", "assetClass": "crypto"},
            "CRV": {"name": "Curve DAO Token", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BAL": {"name": "Balancer", "category": "Cryptocurrency", "assetClass": "crypto"},
            "REN": {"name": "Ren", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ZRX": {"name": "0x", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BAT": {"name": "Basic Attention Token", "category": "Cryptocurrency", "assetClass": "crypto"},
            "MANA": {"name": "Decentraland", "category": "Cryptocurrency", "assetClass": "crypto"},
            "SAND": {"name": "The Sandbox", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ENJ": {"name": "Enjin Coin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "CHZ": {"name": "Chiliz", "category": "Cryptocurrency", "assetClass": "crypto"},
            "HOT": {"name": "Holo", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ANKR": {"name": "Ankr", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ONE": {"name": "Harmony", "category": "Cryptocurrency", "assetClass": "crypto"},
            "IOTA": {"name": "IOTA", "category": "Cryptocurrency", "assetClass": "crypto"},
            "NEO": {"name": "Neo", "category": "Cryptocurrency", "assetClass": "crypto"},
            "GAS": {"name": "Gas", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ONT": {"name": "Ontology", "category": "Cryptocurrency", "assetClass": "crypto"},
            "QTUM": {"name": "Qtum", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ICX": {"name": "ICON", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ZIL": {"name": "Zilliqa", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ZEN": {"name": "Horizen", "category": "Cryptocurrency", "assetClass": "crypto"},
            "RVN": {"name": "Ravencoin", "category": "Cryptocurrency", "assetClass": "crypto"},
            "XMR": {"name": "Monero", "category": "Cryptocurrency", "assetClass": "crypto"},
            "DASH": {"name": "Dash", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ZEC": {"name": "Zcash", "category": "Cryptocurrency", "assetClass": "crypto"},
            "XEM": {"name": "NEM", "category": "Cryptocurrency", "assetClass": "crypto"},
            "WAVES": {"name": "Waves", "category": "Cryptocurrency", "assetClass": "crypto"},
            "OMG": {"name": "OMG Network", "category": "Cryptocurrency", "assetClass": "crypto"},
            "KNC": {"name": "Kyber Network", "category": "Cryptocurrency", "assetClass": "crypto"},
            "STORJ": {"name": "Storj", "category": "Cryptocurrency", "assetClass": "crypto"},
            "SKL": {"name": "SKALE", "category": "Cryptocurrency", "assetClass": "crypto"},
            "GRT": {"name": "The Graph", "category": "Cryptocurrency", "assetClass": "crypto"},
            "1INCH": {"name": "1inch", "category": "Cryptocurrency", "assetClass": "crypto"},
            "CAKE": {"name": "PancakeSwap", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BAKE": {"name": "BakeryToken", "category": "Cryptocurrency", "assetClass": "crypto"},
            "DODO": {"name": "DODO", "category": "Cryptocurrency", "assetClass": "crypto"},
            "ALPHA": {"name": "Alpha Finance Lab", "category": "Cryptocurrency", "assetClass": "crypto"},
            "PERP": {"name": "Perpetual Protocol", "category": "Cryptocurrency", "assetClass": "crypto"},
            "RLC": {"name": "iExec RLC", "category": "Cryptocurrency", "assetClass": "crypto"},
            "OCEAN": {"name": "Ocean Protocol", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BAND": {"name": "Band Protocol", "category": "Cryptocurrency", "assetClass": "crypto"},
            "NMR": {"name": "Numeraire", "category": "Cryptocurrency", "assetClass": "crypto"},
            "MLN": {"name": "Enzyme", "category": "Cryptocurrency", "assetClass": "crypto"},
            "REP": {"name": "Augur", "category": "Cryptocurrency", "assetClass": "crypto"},
            "KEEP": {"name": "Keep Network", "category": "Cryptocurrency", "assetClass": "crypto"},
            "NU": {"name": "NuCypher", "category": "Cryptocurrency", "assetClass": "crypto"},
            "UMA": {"name": "UMA", "category": "Cryptocurrency", "assetClass": "crypto"},
            "BADGER": {"name": "Badger DAO", "category": "Cryptocurrency", "assetClass": "crypto"},
            "FARM": {"name": "Harvest Finance", "category": "Cryptocurrency", "assetClass": "crypto"},
            "PICKLE": {"name": "Pickle Finance", "category": "Cryptocurrency", "assetClass": "crypto"},
            "CREAM": {"name": "Cream Finance", "category": "Cryptocurrency", "assetClass": "crypto"},
            "COVER": {"name": "Cover Protocol", "category": "Cryptocurrency", "assetClass": "crypto"},
            "HEGIC": {"name": "Hegic", "category": "Cryptocurrency", "assetClass": "crypto"},
            "API3": {"name": "API3", "category": "Cryptocurrency", "assetClass": "crypto"},
            "POND": {"name": "Marlin", "category": "Cryptocurrency", "assetClass": "crypto"},
        }

        resolved: Dict[str, Dict] = {}

        for t in tickers:
            if t in static_assets:
                info = static_assets[t]
                resolved[t] = {
                    "ticker": t,
                    "name": info["name"],
